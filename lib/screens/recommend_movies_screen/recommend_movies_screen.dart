...
class RecommendMoviesScreen extends StatefulWidget {
  const RecommendMoviesScreen({super.key});

  static const id = "/recommend-movies-screen";

  @override
  State<RecommendMoviesScreen> createState() => _RecommendMoviesScreenState();
}

class _RecommendMoviesScreenState extends State<RecommendMoviesScreen> {
  ...
  Future<List<Movie>> _getRecommendMovies() async {
    final result = await MovieService().getRecommendMovies(
